...
- # Quality
    - # Lint
        ...
        - SAST (Bandit) `(отчет сохраняется артефактом)`
- # Test
...
- # Deploy (deploy-job)
    ...
    - в producrion при добавлении тега на commit
- # Smoke Test (curl)
...
- # Security
    ...
    - ## SCA (Trivy)
        ...
        -  `отчет сохраняется артефактом`
    - ## K6
        - нагрузоочный тест с 10 виртуальными пользователями в течении 30 секунд
