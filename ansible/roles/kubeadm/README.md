...
This role installs kubeadm, initializes the control plane, joins worker nodes, and installs a CNI plugin (Flannel).
...
| kubeadm_pod_network_cidr | string | "10.244.0.0/16" | Pod network CIDR |
...
| kubeadm_cni_url | string | "https://raw.githubusercontent.com/flannel-io/flannel/master/Documentation/kube-flannel.yml" | CNI manifest |
